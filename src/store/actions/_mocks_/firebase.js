...
export class FirebaseMockReject {
    ...
    static auth = jest.fn(() => {
        return {
            setPersistence: jest.fn(() => Promise.resolve(true)),
            createUserWithEmailAndPassword: jest.fn(() => Promise.resolve('some error')),
            sendPasswordResetEmail: jest.fn(() => Promise.resolve(true)),
            signInWithEmailAndPassword: jest.fn(() => Promise.resolve('some error')),
            fetchSignInMethodsForEmail: jest.fn(() => Promise.resolve(true)),
            signOut: jest.fn(() => Promise.resolve(true)),
            onAuthStateChanged: jest.fn(),
            currentUser: {
